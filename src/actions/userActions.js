...
try{
    const {data} = await axios.post('https://edudigitals.herokuapp.com/api/users/signin',{email, password});
...
export const register = (userRegister) => async(dispatch) =>{
    ...
    try{
        const {data} = await axios.post('https://edudigitals.herokuapp.com/api/users/register', userRegister)
        console.log(data);
...
export const userVerify = (status, id) => async(dispatch) =>{
    ...
    try{
    const {data} = await axios.put(`https://edudigitals.herokuapp.com/api/users/verify/${id}`, {status})
        console.log(data);
...
export const  pendingUsers= () => async(dispatch) =>{
    ...
    try{
        const {data} = await axios.get('https://edudigitals.herokuapp.com/api/users/pendingusers')
...
export const  tutorDetails= (id) => async(dispatch) =>{
    ...
    try{
        const {data} = await axios.get(`https://edudigitals.herokuapp.com/api/users/${id}`)
