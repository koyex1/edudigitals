...
<g id="XMLID_129_">
	<motion.path variants ={props.servicePathVariant} initial="initial" animate={props.inView4? "move":"initial"} stroke="white" className= "shrinkTutor"  strokeWidth="22" fill="none" id="XMLID_134_" d="M473.725,5.656H213.576c-8.655,0-15.655,7.022-15.655,15.664v110.484l11.319-13.234
	...
	<motion.path variants ={props.servicePathVariant} initial="initial" animate={props.inView4? "move":"initial"}  stroke="white" className= "shrinkTutor"  strokeWidth="22" fill="none"  id="XMLID_132_" d="M349.368,97.116c-1.234-3.11-4.732-4.637-7.84-3.406l-92.234,32.555
		...
		/>
	<motion.path variants ={props.servicePathVariant} initial="initial" animate={props.inView4? "move":"initial"} stroke="white" className= "shrinkTutor" strokeWidth="22" fill="none"  id="XMLID_131_" d="M109.928,105.776H92.547c-13.308,0-25.01,6.468-32.448,16.327l-53.352,49.12
	...
	<motion.path variants ={props.servicePathVariant} initial="initial" animate={props.inView4? "move":"initial"}  stroke="white" className= "shrinkTutor" strokeWidth="22" fill="none"  id="XMLID_130_" d="M79.592,91.198c6.495,3.376,13.787,5.471,21.62,5.471c7.853,0,15.145-2.095,21.659-5.477
